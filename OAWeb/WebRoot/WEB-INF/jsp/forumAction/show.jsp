...
<html>
<head>
	<title>【${sessionScope.forum.name}】中的主题列表</title>
...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 【${sessionScope.forum.name}】中的主题列表
        </div>
        <div id="Title_End"></div>
    </div>
</div>

<s:form action="forum_show.htm?forum.id=%{#session.forum.id}">
<div id="MainArea">
	<div id="PageHead"></div>
	<center>
		<div class="ItemBlock_Title1" style="width: 98%;">
			...
			<font class="MenuPoint"> &gt; </font>
			${sessionScope.forum.name}
			<span style="margin-left:30px;">
				<s:a action="topic_addUI.htm">
