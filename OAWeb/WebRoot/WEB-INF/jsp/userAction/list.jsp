    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <s:iterator value="recordList">
            <tr class="TableDetail1 template">
                ...
                <td>${description}&nbsp;</td>
                <td>
                	<s:a action="user_delete?user.id=%{id}" onclick="return delConfirm()">删除</s:a>
                    <s:a action="user_editUI?user.id=%{id}">修改</s:a>
					<s:a action="user_initPassword?user.id=%{id}" onclick="return window.confirm('您确定要初始化密码为1234吗？')">初始化密码</s:a>
                </td>
            </tr>
        </s:iterator> 
...
<s:form action="user_list.htm"></s:form>
