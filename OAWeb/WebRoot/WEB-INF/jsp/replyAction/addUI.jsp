...
<div id="MainArea">
	...
	<s:form action="reply_add.htm" cssStyle="margin: 0; padding: 0;">
		...
		<center>
			<div class="ItemBlock_Title1">
				<div width=85% style="float:left">
					...
					<font class="MenuPoint"> &gt; </font>
					<s:a action="forum_show?forum.id=%{topic.forum.id}">${topic.forum.name}</s:a>
					<font class="MenuPoint"> &gt;&gt; </font>
					帖子回复
				</div>
			</div>
				...
				<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
					...
					<tr>
						...
						<td class="InputAreaBg"><div class="InputContent">
							<input type="text" name="reply.title" style="width:100%" value="回复：${topic.title}"/></div>
						</td>
					</tr>
					<tr height="240">
						...
						<td class="InputAreaBg">
							<div class="InputContent">
								<textarea name="reply.content" style="width:650px;height:200px;"></textarea>
							</div>
						</td>
					</tr>
					<tr height="30">
