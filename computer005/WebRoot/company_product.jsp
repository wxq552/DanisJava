        ...
        <div class="main">
            ...
            <div class="main_content">
                ...
                <div class="right_content">
                    <div class="right_position">您当前的位置：<a href="redirect.jsp" alt="之前的位置">首页</a> -- <span>公司设备</span></div>
                    ...
                    <div class="page_content">
                        <div class="tip">共<span>${count}</span>条 每页<span>${pageSize}<span>条 页次：<span>${currentPage}</span>/<span>${pageCount}</span></div>
                         <div class="page">
                            <a href="getdevice.html?currentPage=${currentPage-1}">< </a>
                            <s:bean name="org.apache.struts2.util.Counter" id="counter">
                               <s:param name="first" value="1" />
                               <s:param name="last" value="pageCount" />
                               <s:iterator>
                               <a href="getdevice.html?currentPage=<s:property />"><s:property/></a>
                               </s:iterator>
                               </s:bean>
                            <a href="getdevice.html?currentPage=${currentPage+1}">></a>
                        </div>
