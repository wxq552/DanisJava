                ...
                <ul>
                    ...
                    <li><a  alt="glory">公司荣誉</a>
                        <ul class="order">
                            ...
                            <li><a href="getdevice.html">公司设备</a></li>
                        </ul>
                    </li>
        ...
        <div class="main">
            ...
            <div class="main_content">
                ...
                <div class="right_content">
                    <div class="right_position">您当前的位置：<a href="redirect.jsp" alt="之前的位置">首页</a> -- <span>公司荣誉</span></div>
                    <div class="right_pshow">
                       
                            <c:forEach items="${list}" var="pro">
                             <div class="p">
                            <a alt="公司荣誉" href="product_detail.html?pro.id=${pro.id}"><img src="${ctx}/upload/${pro.pic_addr}" alt="公司荣誉" width="150px" height="150px;"/></a>
                             <p>介绍一</p>
                             </div>
                            </c:forEach>
                    ...
                    <div class="page_content">
                        ...
                        <div class="page">
                            <a href="product_type.html?currentPage=${currentPage-1}&pro.type=${type}">< </a>
                            <s:bean name="org.apache.struts2.util.Counter" id="counter">
                               <s:param name="first" value="1" />
                               <s:param name="last" value="pageCount" />
                               <s:iterator>
                               <a href="product_type.html?currentPage=<s:property />&pro.type=<s:property value="type"/>"><s:property/></a>
                               </s:iterator>
                               </s:bean>
                            <a href="product_type.html?currentPage=${currentPage+1}&pro.type=${type}">></a>
                        </div>
