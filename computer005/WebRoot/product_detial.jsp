        ...
        <div class="main">
            ...
            <div class="main_content">
                ...
                <div class="right_content">
                    <div class="right_position">您当前的位置：<a href="redirect.jsp" alt="之前的位置">首页</a> -- <a href="product_type.html?pro.type=${pro.type}" alt="之前的位置">产品：${pro.type}</a> -- <span>产品详情</span></div>
                    <div class="introduct_box">
                        <div class="right_product">
                        <img src="${ctx}/upload/${pro.pic_addr}" width=265 height=265 alt="" />
                        </div>
                        <div class="right_article">
                            <div class="article_float">
                                ...
                                <div class="product_introduct">
                                    <p>型号：${pro.xinghao}</p>
                                    <p>产品描述：<span>${pro.description}</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="product_detial">
                        <p>产品介绍：<span>${pro.intro}</span></p>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
