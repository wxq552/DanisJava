                ...
                <div class="right_content">
                    ...
                    <div class="right_pshow">
                            ...
                            <c:forEach items="${piclist}" var="pic">
                             <div class="p">
                            <a alt="公司荣誉"><img src="${ctx}/upload${pic.pic_address}" alt="公司荣誉" width="150px" height="150px;"/></a>
                             <p>介绍一</p>
                             </div>
                            </c:forEach>
                    ...
                    <div class="page_content">
                        ...
                        <div class="page">
                            <a href="getglory.html?currentPage=${currentPage-1}">< </a>
                            <s:bean name="org.apache.struts2.util.Counter" id="counter">
                               <s:param name="first" value="1" />
                               <s:param name="last" value="pageCount" />
                               <s:iterator>
                               <a href="getglory.html?currentPage=<s:property />"><s:property/></a>
                               </s:iterator>
                               </s:bean>
                            <a href="getglory.html?currentPage=${currentPage+1}">></a>
                        </div>
