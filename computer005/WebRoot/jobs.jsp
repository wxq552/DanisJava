        ...
        <div class="main">
            ...
            <div class="main_content">
                ...
                <div class="right_content">
                    <div class="right_position">您当前的位置：<a href="redirect.jsp" alt="之前的位置">首页</a> --  <span>人才招聘</span></div>
                    <div class="right_pshow">
                        <table>

                        <tr class="speaial_tr">
                            <td class="special_td">招聘单位</td>
                            <td class="normal">工作地点</td>
                            <td class="normal">招聘人数</td>
                            <td class="normal">详情</td>
                        </tr>
                        <c:forEach items="${joblist}" var="job">
                        <tr>
                            <td class="special_td">${job.unit}</td>
                            <td class="normal">${job.place}</td>
                            <td class="normal">${job.num}</td>
                            <td class="normal"><a href="jobs_detial.html?job.id=${job.id}">详情</a></td>
                        </tr>
                        </c:forEach>
                        </table>
                    </div>
                    <div class="page_content">
                         <div class="tip">共<span>${count}</span>条 每页<span>${pageSize}<span>条 页次：<span>${currentPage}</span>/<span>${pageCount}</span></div>
                         <div class="page">
                            <a href="jobs.html?currentPage=${currentPage-1}">< </a>
                            <s:bean name="org.apache.struts2.util.Counter" id="counter">
                               <s:param name="first" value="1" />
                               <s:param name="last" value="pageCount" />
                               <s:iterator>
                               <a href="jobs.html?currentPage=<s:property />"><s:property/></a>
                               </s:iterator>
                               </s:bean>
                               <a href="jobs.html?currentPage=${currentPage+1}">></a>
                        </div>
