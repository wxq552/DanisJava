        ...
        <div class="main">
            ...
            <div class="main_content">
                ...
                <div class="right_content">
                    <div class="right_position">您当前的位置：<a href="redirect.jsp" alt="之前的位置">首页</a> -- <a href="jobs.html" alt="之前的位置">人才招聘</a> -- <span>招聘详情</span></div>
                        <div class="job_content">
                            <ul>
                                <li class="all">
                                    职位名称：<span>${job.job_name}</span>
                                </li>
                                <li class="all">
                                    职位类型：<span>${job.job_type}</span>
                                </li>
                                <li class="all">
                                    工作经验：<span>${job.experience}年以上</span>
                                </li>
                                <li class="all">
                                    学历要求：<span>${job.quality}</span>
                                </li>
                                <li class="all">
                                    招聘人数：<span>${job.num}名</span>
                                </li>
                                <li class="all">
                                    发布时间：<span>${job.post_time}</span>
                                </li>
                                <li class="detial">
                                    职位描述：<img src="./images/product_p.png">
                                </li>
                                <li class="all border">
                                   ${job.description}
                                </li>
                                <li class="detial">
                                    招聘要求：<img src="./images/product_p.png">
                                </li>
                                <li class="all border">
                                    ${job.requirement}
                                </li>
                                <li class="all margin">
                                    联系人：<span>${job.contactor}</span>
                                </li>
                                <li class="all">
                                    联系电话：<span>${job.phone}</span>
                                </li>
                                <li class="all">
                                    联系邮件：<span>${job.email}</span>
                                </li>
                            </ul>
                        </div>
                </div>
