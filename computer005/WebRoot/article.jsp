        ...
        <div class="main">
            ...
            <div class="main_content">
                ...
                <div class="right_content">
                    <div class="right_position">您当前的位置：<a href="redirect.jsp" alt="之前的位置">首页</a> -- <span>新闻详细</span></div>
                    <div class="right_title">${art.title}</div>
                    <div class="right_tip">更新时间：${art.posttime}编辑： ${art.author}   有${art.count}位读者读过此文</div>
